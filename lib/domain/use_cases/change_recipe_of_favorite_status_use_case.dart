...
class ChangeRecipeOfFavoriteStatusUseCase
    implements UseCase<Recipe, Future<void>> {
  final RecipeRepository _recipeRepository;

  ChangeRecipeOfFavoriteStatusUseCase(this._recipeRepository);
  ...
  Future<void> call(Recipe recipe) async {
    ...
    //レシピのお気に入り状態を変更する
    await _recipeRepository.changeFavoriteStatus(recipeModel);
  }
}
