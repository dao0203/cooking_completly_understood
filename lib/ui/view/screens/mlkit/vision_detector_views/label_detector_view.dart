...
class ImageLabelView extends ConsumerStatefulWidget {
  const ImageLabelView({super.key});

  @override
  ConsumerState<ImageLabelView> createState() => _ImageLabelViewState();
}

class _ImageLabelViewState extends ConsumerState<ImageLabelView> {
  ...
  Future<void> processImage(InputImage inputImage) async {
    final foodsStateNotifier = ref.watch(foodsStateProvider.notifier);
    ...
    if (inputImage.metadata?.size != null &&
      ...
      final painter = LabelDetectorPainter(labels, foodsStateNotifier);
